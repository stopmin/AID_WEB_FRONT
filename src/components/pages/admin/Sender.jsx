    ...
    <div className="flex justify-center items-center">
      <section className="banner">
        <Container>
          ...
          <div>
            <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 text-white">
              Title:
            </label>
            <input
              type="text"
            ...
            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 text-white">
              Message:
            </label>
            <textarea
              id="message"
